...
set(SORT_FILTER_PROXY_MODEL_SOURCES
...
if (EXTRACHAIN_STATIC_BUILD)
    add_library(SortFilterProxyModel OBJECT
        ${SORT_FILTER_PROXY_MODEL_SOURCES}
    )
else()
...
target_include_directories(SortFilterProxyModel PUBLIC ${CMAKE_CURRENT_LIST_DIR} ${CMAKE_CURRENT_LIST_DIR}/filters ${CMAKE_CURRENT_LIST_DIR}/proxyroles ${CMAKE_CURRENT_LIST_DIR}/sorters)
target_link_libraries(SortFilterProxyModel
    PRIVATE Qt5::Core Qt5::Network Qt5::Qml Qt5::Quick Qt5::QuickControls2 Qt5::Svg Qt5::Widgets Qt5::Location extrachain)
set_property(TARGET SortFilterProxyModel PROPERTY POSITION_INDEPENDENT_CODE 1)
message("--- SortFilterProxyModel ---")
